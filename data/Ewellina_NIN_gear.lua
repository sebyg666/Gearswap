...
function init_gear_sets()
	...
	sets.engaged['DW: 39'] 					= set_combine(sets.engaged, 							{ammo=gear.DakanAmmo,
	...
	-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	--------------------------------------------
	-- Custom melee group: low Haste ('DW: 37-38')     
	--------------------------------------------         
	
	sets.engaged['DW: 37-38'] 				= set_combine(sets.engaged['DW: 39'], 					{body=AAdhemar_body_Acc,feet=Herc_feet_TP_Acc})
	...
	-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	--------------------------------------------		
	-- Custom melee group: low Haste ('DW: 35-36')-        
	--------------------------------------------           
	
	sets.engaged['DW: 35-36'] 				= set_combine(sets.engaged['DW: 37-38'], 				{waist="Windbuffet Belt +1",legs=Samnuha_Tights,feet="Hizamaru Sune-ate +1"})
	...
	-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	--------------------------------------------			
	-- Custom melee group: low Haste ('DW: 32-34')-         
	--------------------------------------------            
	
	sets.engaged['DW: 32-34'] 				= set_combine(sets.engaged['DW: 35-36'], 				{legs=Herc_legs_DW,feet=Herc_feet_TP_Acc})
	...
	-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	--------------------------------------------			
	-- Custom melee group: low Haste ('DW: 29-31')-         
	--------------------------------------------            
	
	sets.engaged['DW: 29-31'] 				= set_combine(sets.engaged['DW: 32-34'], 				{head=Adhemar_head,waist="Patentia Sash"})
	...
	-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	--------------------------------------------			
	-- Custom melee group: MidHaste ('DW: 26-28')-          
	--------------------------------------------            
	
	sets.engaged['DW: 26-28'] 				= set_combine(sets.engaged['DW: 29-31'], 				{hands=Adhemar_hands_Acc,waist="Windbuffet Belt +1",feet="Hizamaru Sune-ate +1"})
	...
	-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	---------------------------------------------			
	-- Custom melee group: High Haste ('DW: 22-25')         
	---------------------------------------------           
	
	sets.engaged['DW: 22-25'] 				= set_combine(sets.engaged['DW: 26-28'], 				{legs=Samnuha_Tights})
	...
	-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	---------------------------------------------			
	-- Custom melee group: High Haste ('DW: 21')            
	---------------------------------------------           
	
	sets.engaged['DW: 21'] 					= set_combine(sets.engaged['DW: 22-25'], 				{ear2="Cessance Earring",legs=Herc_legs_DW})
	...
	sets.engaged['DW: 20'] 					= set_combine(sets.engaged['DW: 21'], 					{ear2="Suppanomimi",waist="Patentia Sash",legs=Samnuha_Tights,feet=Herc_feet_TP_Acc})
	...
	-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	---------------------------------------------			
	-- Custom melee group: High Haste ('DW: 17-19')         
	---------------------------------------------           
	
	sets.engaged['DW: 17-19'] 				= set_combine(sets.engaged['DW: 20'], 					{ear2="Cessance Earring",waist="Windbuffet Belt +1",feet="Hizamaru Sune-ate +1"})
	...
	-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	---------------------------------------------			
	-- Custom melee group: High Haste ('DW: 14-16')         
	---------------------------------------------           
	
	sets.engaged['DW: 14-16'] 				= set_combine(sets.engaged['DW: 17-19'], 				{legs=Herc_legs_DW,feet=Herc_feet_TP_TA})
	sets.engaged['Ilvl~118']['DW: 14-16'] 	= set_combine(sets.engaged['DW: 14-16'], 				{feet=Herc_feet_TP_Acc})
	...
	-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	---------------------------------------------			
	-- Custom melee group: High Haste ('DW: 10-13')          
	---------------------------------------------           
	
	sets.engaged['DW: 10-13'] 				= set_combine(sets.engaged['DW: 14-16'], 				{legs=Samnuha_Tights})
	sets.engaged['Ilvl~118']['DW: 10-13'] 	= set_combine(sets.engaged['DW: 10-13'], 				{feet=Herc_feet_TP_Acc})
	...
	-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------			
	-- Custom melee group: Max Haste ('DW: 0-9')        
	-----------------------------------------           
	
	sets.engaged['DW: 0-9'] 				= set_combine(sets.engaged['DW: 10-13'],					{ear1="Brutal Earring",body=Herc_body_TA_TA})
	sets.engaged['Ilvl~118']['DW: 0-9'] 	= set_combine(sets.engaged['DW: 0-9'], 					{feet=Herc_feet_TP_Acc})
